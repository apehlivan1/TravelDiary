...
public class HomeController {
    ...
    public HomeController(int userId) { this.userId = userId; }
    /**
    ...
    void editButtonClicked(ActionEvent event) throws IOException {
        ...
        loader.setController(new TripInfoController(userId, chosenTrip, chosenDestination));
        Parent root = loader.load();
        newStage(root, null);
    }
    ...
    private void refreshList() {
        try {
            ...
            for (Trip trip: tripsList) {
                ...
                destinationsList.setItems(FXCollections.observableList(destinations));
            }
        } catch (AppException e) {
            new Alert(Alert.AlertType.NONE, e.getMessage(), ButtonType.OK).show();
        }
